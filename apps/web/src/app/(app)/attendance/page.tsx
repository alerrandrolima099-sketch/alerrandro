...
// Aquecimento - Mensagens (seção 38/43): monitor das trocas de mensagem de
// aquecimento entre os números do tenant - NÃO é uma caixa de entrada de
// clientes (isso é a página Conversas, em "/conversations"). Até a seção
// 43 esse código vivia na rota "/conversations" e "/attendance" mostrava o
// inbox real de leads - a pedido do usuário, os dois trocaram de lugar
// (ver comentário em conversations/page.tsx). Reaproveita os mesmos
// endpoints que a Central de Aquecimento já usa (/warmup-pairs e
// /warmup-pairs/:id/messages) - nenhum dado novo, só uma forma melhor de
// visualizar o que já existia escondido num accordion.
    ...
    <div className="h-[calc(100vh-4rem)] -m-6 md:-m-8 flex bg-background">
      <div className="w-full md:w-80 border-r border-border overflow-y-auto flex flex-col">
        <div className="p-4 border-b border-border">
          <h1 className="font-semibold">Aquecimento - Mensagens</h1>
