...
// Conversas (seção 38/43): inbox real de clientes (leads), com
// envio/recebimento ao vivo via WebSocket e retry de mensagem falhada. Até
// a seção 43 esse código vivia na rota "/attendance" ("Atendimentos") e
// "/conversations" mostrava um monitor de aquecimento entre números - a
// pedido do usuário, os dois trocaram de lugar, porque "Conversas" era o
// nome que ele esperava encontrar para falar com os leads. O monitor de
// aquecimento agora mora em "/attendance" (renomeado na navegação para
// deixar claro o que é). O comportamento aqui é 100% o mesmo que já estava
// validado em produção, só mudou de rota/nome.
