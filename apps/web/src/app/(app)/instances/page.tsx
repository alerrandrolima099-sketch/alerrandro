  ...
  return (
    <div>
      ...
      {/* Faixa "Números disponíveis para escala" (seção 46) - resumo visual
          de quantos números estão conectados e ativos agora, prontos pra
          escalar o atendimento. Puramente informativo (mesma contagem que já
          existia em texto simples aqui em cima), só que em destaque - pedido
